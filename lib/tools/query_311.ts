...
const HYDE_PARK_2024: Record<number, ServiceResult> = {
  1:  { total_requests: 142, by_type: { pothole: 41, 'streetlight outage': 31, 'graffiti removal': 22, 'tree debris': 28, heating: 22, other: 20 }, avg_response_days: 4.1 },
  2:  { total_requests: 128, by_type: { pothole: 38, 'streetlight outage': 28, 'graffiti removal': 20, 'tree debris': 22, heating: 24, other: 20 }, avg_response_days: 4.3 },
  3:  { total_requests: 161, by_type: { pothole: 52, 'streetlight outage': 29, 'graffiti removal': 24, 'tree debris': 35, heating: 18, other: 21 }, avg_response_days: 5.1 },
  ...
  11: { total_requests: 149, by_type: { pothole: 43, 'streetlight outage': 32, 'graffiti removal': 23, 'tree debris': 31, heating: 16, other: 20 }, avg_response_days: 4.5 },
  12: { total_requests: 138, by_type: { pothole: 40, 'streetlight outage': 33, 'graffiti removal': 21, 'tree debris': 25, heating: 20, other: 19 }, avg_response_days: 4.2 },
}
